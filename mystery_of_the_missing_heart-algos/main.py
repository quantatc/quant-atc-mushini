...
thread2 = threading.Thread(target=run_script, args=(directory + r"\moth_scalping101_oanda.py", env_path))
thread3 = threading.Thread(target=run_script, args=(directory + r"\moth_volatility_deriv.py", env_path))
thread4 = threading.Thread(target=run_script, args=(directory + r"\moth_scalping101_binance.py", env_path))
